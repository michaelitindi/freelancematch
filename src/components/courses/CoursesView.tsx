  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Complete courses to unlock new categories and boost your matching priority
          </p>
        </div>
              ...
              return (
                ...
                >
                  <div className="aspect-video relative overflow-hidden">
                    ...
                    <span className="absolute top-3 right-3 text-3xl">{course.badge}</span>
      ...
      <Card className="card-shadow bg-gradient-to-br from-[#1A2B4A] to-[#2A3B5A] text-white">
        <CardHeader>
          <CardTitle className="font-display text-white">Why Complete Courses?</CardTitle>
        </CardHeader>
        <CardContent>
          ...
          <Card className="card-shadow mb-6">
            <CardContent className="p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="font-mono text-[#00B8A9]">{Math.round(progress)}%</span>
              </div>
              ...
              {course.modules.map((module, index) => (
                <button
                  ...
                  className={cn(
                    ...
                    activeModule === index ? "bg-[#00B8A9]/10" : "hover:bg-muted/50"
                  )}
                >
                  <div className={cn(
